...
_G.packer_plugins = {
  ["42header"] = {
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/42header",
  ...
  ["cheat-sheet"] = {
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/cheat-sheet",
  ...
  ["nvim-dap-go"] = {
    loaded = true,
    path = "/data/data/com.termux/files/home/.local/share/nvim/site/pack/packer/start/nvim-dap-go",
